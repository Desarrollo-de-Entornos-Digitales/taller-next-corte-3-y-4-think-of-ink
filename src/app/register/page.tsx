            ...
            <div className="card bg-base-100 w-full max-w-md shadow-xl border border-slate-200 p-8">
                ...
                <form className="space-y-4">
                    <div className="form-control">
                        ...
                        <input type="text" placeholder="@artist_name" className="input input-bordered" />
                    </div>
                    ...
                    <div className="form-control">
                        ...
                        <input type="email" placeholder="correo@ejemplo.com" className="input input-bordered" />
                    </div>
                    ...
                    {/* Botón Principal usando CustomButton */}
